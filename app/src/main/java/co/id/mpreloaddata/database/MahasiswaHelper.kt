package co.id.mpreloaddata.database
...
import co.id.mpreloaddata.database.DatabaseContract.MahasiswaColumns.Companion.NAMA
import co.id.mpreloaddata.database.DatabaseContract.MahasiswaColumns.Companion.NIM
import co.id.mpreloaddata.database.DatabaseContract.TABLE_NAME
import co.id.mpreloaddata.model.MahasiswaModel
