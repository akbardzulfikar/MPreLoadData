package co.id.mpreloaddata.services

import android.app.Service
import android.content.Intent
import android.os.*
import android.util.Log
import co.id.mpreloaddata.R
import co.id.mpreloaddata.database.MahasiswaHelper
import co.id.mpreloaddata.model.MahasiswaModel
import co.id.mpreloaddata.pref.AppPreference
